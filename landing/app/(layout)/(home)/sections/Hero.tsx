  ...
  return (
    <div className="relative flex items-center justify-between px-4 flex-col-reverse md:flex-row my-10 md:my-32">
      <div className="flex flex-col space-y-6 items-center md:items-start  max-w-lg">
        <h1 className="title font-bold uppercase leading-[1] text-[50px] md:text-[85px] ">Automate your content</h1>
        <p className="text-[22px] leading-[30px] font-light">Automate your video editing and integrate videos with dynamic data on your site.</p>
        ...
        <div className="relative w-[95%] mb-10 md:mb-0">
          ...
          <div className="animate-slide-from-right-700">
            <video
              ...
              muted
            />
            <Image priority src="/laptop.png" alt="laptop" height={1000} width={1000} className="relative " />
          </div>
        </div>
      </div>
    </div>
