...
export const texts: CompProps[] = [
    {
        ...base, id: "letter-scale",
    },
    {
        ...base, id: "letter-fade",
        animation: { type: "letter-by-letter", animation: "fade-in", duration: 2 }
    },
    {
        ...base, id: "letter-up",
        animation: { type: "letter-by-letter", animation: "slide-up", duration: 2 }
    },
    {
        ...base, id: "word-up",
    ...
    {
        ...base, id: "line-right",
        animation: { type: "line-by-line", animation: "slide-right", duration: 2 }
    },
