        ...
        {navLinks.map((nav, i) => (
          ...
          >
            <div className="relative">
              <h1 className=" title text-[18px] font-semibold">{nav.title}</h1>
              <div className="absolute left-0  w-6 h-[2px] bg-gradient-to-r from-primary to-secondary" />
            </div>
            <div className="flex flex-col space-y-2 ">
              {nav.items.map((item, i) => (
                <Link
                  key={i}
                  className="text-[#8f8f8f] text-[16px] font-normal hover:scale-105 duration-200"
                  href={item.href}
                >
                  {" "}
                  {item.name}
        ...
        <div className="col-span-2 ">
          <div className="flex flex-col items-center md:items-baseline md:flex md:flex-col space-y-4 md:space-y-4 max-w-[250px]">
            <div className="flex flex-col md:flex md items-left md:items-left ">
              <h1 className=" title text-[18px] font-semibold">Subscribe</h1>
            ...
            <div className=" flex-col space-y-2 ">
              ...
              />
              <button className="rounded-full p-2  items-center  text-sm btn-gradient hover:scale-105 duration-300">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="mt-12">
        ...
        <div className="md:flex md:justify-between mx-4 md:mx-12 my-5 ">
          <div className="md:flex md:flex-row space-x-3">
            <p className="font-normal text-sm text-[#8f8f8f]">
              Copyright © 2023 Motionly.
            </p>
            <p className="font-semibold text-sm text-[#8f8f8f]">
              All rights reserved
            </p>
          </div>
          <div className="md:flex md:flex-row space-x-3">
            <a href="/terms" className="font-normal text-sm text-[#8f8f8f]">
              Terms & conditions
            </a>
            <a href="/cookies" className="font-normal text-sm text-[#8f8f8f]">
              Privacy policy
            </a>
          </div>
        </div>
